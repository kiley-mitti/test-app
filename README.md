# Creating an Astro Interface

This is my first ever use of AstroUXDS to create a working interface using dummy data. When complete it should function as to the specifications below.
